    ...
    filesystem = {
      window = {
        mappings = {
          ["H"] = "toggle_hidden",
          -- ["/"] = "fuzzy_finder",
          ["/"] = "noop", -- Disable fuzzy finder, to keep default vim / buffer search
...
vim.cmd('highlight NeoTreeFloatBorder guibg='..colors.bg..' guifg='..colors.blue)
vim.cmd('highlight NeoTreeFloatTitle guibg='..colors.bg)
